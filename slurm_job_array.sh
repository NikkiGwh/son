...
configNames[0]="./experiment_paper_configs/het_C50_MP30_MS1,2ms_evo_var.json"
configNames[1]="./experiment_paper_configs/het_C50_MP70_MS1,2ms_evo_var.json"
configNames[2]="./experiment_paper_configs/het_C50_MP100_MS1,2ms_evo_var.json"

configNames[3]="./experiment_paper_configs/het_C50_MP30_MS14ms_evo_var.json"
configNames[4]="./experiment_paper_configs/het_C50_MP70_MS14ms_evo_var.json"
configNames[5]="./experiment_paper_configs/het_C50_MP100_MS14ms_evo_var.json"
...
# elif [ $SLURM_ARRAY_TASK_ID -le 59 ]
# then
...
# elif [ $SLURM_ARRAY_TASK_ID -le 71 ]
# then
...
# elif [ $SLURM_ARRAY_TASK_ID -le 74 ]
# then
#     srun apptainer exec nns.sif python network_simulation_script.py het_C50 ${configNames[${SLURM_ARRAY_TASK_ID}]}
#     echo apptainer exec nns.sif python network_simulation_script.py het_C50 ${configNames[${SLURM_ARRAY_TASK_ID}]}
# else
